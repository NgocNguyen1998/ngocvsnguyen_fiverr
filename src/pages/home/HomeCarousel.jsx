                ...
                <div >
                    <div style={{ ...contentStyle, backgroundImage: `url('https://tse1.mm.bing.net/th?id=OIP.xl6aPdf_YteEhSyOA59bpAHaHg&pid=Api&P=0')` }}>
                        <div className="container content 2xl:py-20 xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
                            <div className='pb-14'>
                                <h1 className='text-white 2xl:text-6xl xl:text-6xl lg:text-5xl md:text-4xl sm:text-2xl  text-2xl text-left'>Find the perfect <i>freelance</i>
                                ...
                                <form className=" space-y-1 dark:text-gray-100" onSubmit={handleSubmit((data) => {
                                    ...
                                    <div className="flex">
                                        <input type="text" className='rounded-sm 2xl:pr-96 xl:pr-80 lg:pr-64 md:pr-48 sm:pr-32 pr-16 pl-3 py-3 text-pink-600' placeholder='Try "building mobile app"' {...register("jobname")} />
                                ...
                                <div className='flex pt-8'>
                                    <h2 className=' text-white  font-bold 2xl:text-xl xl:text-xl lg:text-xl md:text-xl sm:text-xl  text-base' >Popular: </h2>
                        ...
                        <div className="container content 2xl:py-20 xl:py-16 lg:py-14 md:py-12 sm:py-10 py-8">
                            <div className='pb-14'>
                                ...
                                <form className=" space-y-1 dark:text-gray-100">
                                    <div className="flex">
                                        <input type="text"  className='rounded-sm 2xl:pr-96 xl:pr-80 lg:pr-64 md:pr-48 sm:pr-32 pr-16 pl-3 py-3 text-pink-600' placeholder='Try "building mobile app"' />
