...
import { getRentList, useThueCongViec } from '../../storeToolKit/ThueCongViec';
const InfoUser = () => {
                    ...
                    <div className='top '>
                        <div className=" max-w-lg p-6 space-y-4 overflow-hidden rounded-lg shadow-md bg-white " >
                            ...
                            <div className='pt-6 flex flex-col content-center items-center'>
                                <img src={infoUser.avatar} alt='...' className="object-cover   rounded-full " style={{ height: '200px', width: '200px' }} />
                    ...
                    <div className='work  bg-white pt-6 px-4 border-t-2 border-black pb-2'>
                        <div className='grid grid-cols-4 gap-x-3'>
                            ...
                            <div className='col-span-3'>
                                ...
                                <div>
                                    <h1 className='text-xl'>Lập trình front end với reactjs</h1>
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae, quia!</p>
                                    <p><Rate disabled defaultValue={4} style={{ fontSize: '15px' }} /></p>
                                </div>

                            </div>
                        </div>
                        <div className=' flex justify-end pb-2'>
                            <button className='border-2  py-1 px-4 rounded-md border-pink-400 hover:text-white hover:bg-pink-300 transition-all duration-300'>View detail</button>
                            ...
                            <button className='border-2 py-1 px-4 text-red-500 font-medium rounded-md border-pink-400 hover:bg-pink-300 transition-all duration-300'>X</button>
                        </div>
                    </div>
