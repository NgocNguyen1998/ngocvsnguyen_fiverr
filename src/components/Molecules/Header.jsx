      ...
      return (
        <Div className="flex gap-3 items-center ">
          <img
            ...
            alt="avatar"
          />
          <p className="mb-0" onClick={()=> navigate(`/infoUser/${JSON.parse(userLogin).id}`)}>{JSON.parse(userLogin).name}</p>
          <p className="flex flex-cols m-0">
            ...
            <div className="w-[180px] h-[470px] ml-[-10px] info  text-base text-white rounded-md bg-blue-400 absolute mt-8">
              <div className="relative ribbon">
                ...
                <div>
                  <p className="flex justify-start tagp gap-5 mt-4 items-center"  onClick={()=> navigate(`/infoUser/${JSON.parse(userLogin).id}`)}>
