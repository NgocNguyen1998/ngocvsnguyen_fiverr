...
export const Header = () => {
  ...
  return (
    ...
    <ul className="items-stretch hidden space-x-3 lg:flex pl-20">
          <li className="flex">
            <NavLink className="flex items-center px-4 -mb-3 text-black font-medium" to="/">
              Become a Seller
            </NavLink>
          </li>
        ...
        <div className="items-center flex-shrink-0 hidden lg:flex">
          <button className="self-center px-8 py-3 rounded text-black font-medium">Sign in</button>
          <button
